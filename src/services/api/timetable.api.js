...
export const timetableAPI = {
  ...
  getAbsenceImpact: (params) => fetchWithAuth(`/timetable/relief/impact?${new URLSearchParams(params)}`),
  assignRelief: (data) => fetchWithAuth('/timetable/relief/assign', { method: 'POST', body: JSON.stringify(data) }),
  batchAssignRelief: (data) => fetchWithAuth('/timetable/relief/batch-assign', { method: 'POST', body: JSON.stringify(data) }),
  getSyllabusDeficit: (params) => fetchWithAuth(`/timetable/relief/deficit${params ? `?${new URLSearchParams(params)}` : ''}`),
  getCalendarMilestones: (params) => fetchWithAuth(`/timetable/calendar-milestones${params ? `?${new URLSearchParams(params)}` : ''}`),
  getEffectiveSchedule: (params) => fetchWithAuth(`/timetable/effective-schedule${params ? `?${new URLSearchParams(params)}` : ''}`),
