...
const ACCOUNTANT_NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { label: 'Student Statements', path: 'fees-statements', icon: FileText },
      { label: 'Fee Types', path: 'fees-types', icon: Receipt },
      { label: 'Fee Structure', path: 'fees-structure', icon: FileText },
