...
const PREFETCH_MAP = {
  ...
  'fees-invoices':        () => import('../pages/FeeCollectionPage'),
  'fees-collection':      () => import('../pages/FeeCollectionPage'),
  'fees-collection-summary': () => import('../pages/FeeCollectionPage'),
  'fees-balances':        () => import('../pages/FeeCollectionPage'),
  'fees-followup':        () => import('../pages/FeeCollectionPage'),
  'fees-insights':        () => import('../pages/FeeCollectionPage'),
  ...
  'reports-center':       () => import('../pages/ReportsCenterPage'),
  ...
  'learning-dashboard':   () => import('../pages/lms/analytics/LearningAnalyticsPage'),
...
const ACCOUNTANT_NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { label: 'Fee Invoices', path: 'fees-invoices', icon: Receipt },
