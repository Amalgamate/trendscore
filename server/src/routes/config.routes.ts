 ...
 * @access  ADMIN, SUPER_ADMIN, HEAD_TEACHER, HEAD_OF_CURRICULUM, TEACHER, ACCOUNTANT, PARENT
 */
router.get(
  '/term/active',
  requireRole(['ADMIN', 'SUPER_ADMIN', 'HEAD_TEACHER', 'HEAD_OF_CURRICULUM', 'TEACHER', 'ACCOUNTANT', 'PARENT']),
  rateLimit({ windowMs: 60_000, maxRequests: 100 }),
